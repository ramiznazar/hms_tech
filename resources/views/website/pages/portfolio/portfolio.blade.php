...
@section('content')
    <main>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="zq_breadcrumb-content text-center">
                                <h2 class="zq_breadcrumb-content-title">Portfolio</h2>
        ...
        <!-- project area start -->
        <section class="zq_inner_project-area pt-100 pb-100">
            <div class="container">
                <div class="row">
                    @forelse($portfolios as $item)
                        <div class="col-lg-6">
                            <div class="zq_inner_project-item mb-35">
                                <div class="zq_inner_project-img" style="height:70vh; overflow:hidden;">
                                    <a href="{{ route('portfolio.detail', $item->id) }}" style="display:block; height:100%;">
                                        @if($item->thumbnail)
                                            <img src="{{ asset($item->thumbnail) }}" alt="{{ $item->title }}" style="width:100%; height:100%; object-fit:cover;">
                                        @else
                                            <img src="{{ asset('assets/website/images/project/inner_1.png') }}" alt="{{ $item->title }}" style="width:100%; height:100%; object-fit:cover;">
                                        @endif
                                    </a>
                                </div>
                                <div class="zq_inner_project-content">
                                    <div class="zq_inner_project-content-head">
                                        <h3 class="zq_inner_project-content-title">
                                            <a href="{{ route('portfolio.detail', $item->id) }}">{{ $item->title }}</a>
                                        </h3>
                                        <a href="{{ route('portfolio.detail', $item->id) }}" class="zq_inner_project-content-btn">
