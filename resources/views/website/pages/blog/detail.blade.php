...
@section('content')
    <main>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="zq_breadcrumb-content text-center">
                                <h2 class="zq_breadcrumb-content-title">Blog Details</h2>
        ...
        <!-- blog details start -->
        <section class="zq_blog_details-area pt-100 pb-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="zq_blog_details-left mb-40">
                            <div class="zq_blog_details-content">
                                <div class="zq_blog_details-content-img mb-20">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/website/images/blog/blog_big-1.png') }}" alt="{{ $blog->title }}">
                                    @endif
                                </div>
                                <h3 class="zq_blog_details-content-title mb-20">{{ $blog->title }}</h3>
                                <div class="zq_blog_details-content-meta">
                                    <span>
                                        <i class="fa-sharp fa-light fa-circle-user" style="font-size:32px;"></i>
                                        <a href="#">By {{ $blog->author }}</a>
                                    </span>
                                    @if($blog->published_at)
                                    <span><i class="fa-sharp fa-light fa-calendar"></i>{{ $blog->published_at->format('d M, Y') }}</span>
                                    @endif
                                </div>
                                <div class="zq_blog_details-content-text mb-10">
                                    {!! $blog->description !!}
                                </div>
                                <div class="zq_blog_details-content-bottom mb-40">
                                    <div class="zq_blog-widget-tag">
                                        @if($blog->tags)
                                    ...
                                    <div class="zq_blog_details-content-social">
                        ...
                        {{-- <div class="mb-40">
                            <h4 class="zq_blog-widget-title mb-30">Leave a Comment</h4>
                            <form action="#">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-20">
                                            <input type="text" placeholder="Your Name" style="background:#1a3d36; border:1px solid rgba(255,255,255,0.15); color:#fff; padding:14px 20px; border-radius:6px; width:100%;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-20">
                                            <input type="email" placeholder="Your Email" style="background:#1a3d36; border:1px solid rgba(255,255,255,0.15); color:#fff; padding:14px 20px; border-radius:6px; width:100%;">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-20">
                                            <textarea rows="5" placeholder="Write your comment..." style="background:#1a3d36; border:1px solid rgba(255,255,255,0.15); color:#fff; padding:14px 20px; border-radius:6px; width:100%; resize:none;"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" style="display:inline-flex; align-items:center; gap:8px; background:var(--clr-theme-primary); color:#000; font-weight:600; padding:14px 30px; border:none; border-radius:6px; cursor:pointer;">
                                            Post Comment
                    ...
                    <div class="col-lg-4">
                        <div class="zq_blog_widget-wrap mb-40 ml-30">
                            <div class="zq_blog-widget">
                                <h4 class="zq_blog-widget-title">Search Here</h4>
                                <form action="#">
                            ...
                            <div class="zq_blog-widget">
                                <h4 class="zq_blog-widget-title">Popular Post</h4>
                                <div class="zq_blog-widget-post mb-15">
                                    <div class="zq_blog-widget-post-img">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/website/images/blog/blog_post-1.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="zq_blog-widget-post-content">
                                        <h4><a href="blog-details.html">Digital Disc Conversations on Innovative IT
                                                Solutions</a></h4>
                                        <span><i class="fa-sharp fa-light fa-calendar"></i>Mar 18, 2028</span>
                                    </div>
                                </div>
                                <div class="zq_blog-widget-post mb-15">
                                    <div class="zq_blog-widget-post-img">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/website/images/blog/blog_post-2.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="zq_blog-widget-post-content">
                                        <h4><a href="blog-details.html">Beyond Bound Charting New Territories in IT
                                                Solutions</a></h4>
                                        <span><i class="fa-sharp fa-light fa-calendar"></i>Mar 18, 2028</span>
                                    </div>
                                </div>
                                <div class="zq_blog-widget-post">
                                    <div class="zq_blog-widget-post-img">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('assets/website/images/blog/blog_post-3.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="zq_blog-widget-post-content">
                                        <h4><a href="blog-details.html">Beyond the Cutting-Edge IT Solutions Unveiled</a>
                                        </h4>
                                        <span><i class="fa-sharp fa-light fa-calendar"></i>Mar 18, 2028</span>
                                    </div>
                                </div>
                            ...
                            <div class="zq_blog-widget">
                                ...
                                <ul class="zq_blog-widget-category">
                                    <li><a href="#">TechLeadership <span>(03)</span></a></li>
                                    <li><a href="#">TechTalks <span>(04)</span></a></li>
                                    <li><a href="#">TechTrends <span>(02)</span></a></li>
                                    <li><a href="#">Innovate <span>(05)</span></a></li>
                                    <li><a href="#">MLTech <span>(02)</span></a></li>
                                </ul>
                            </div>
                            <div class="zq_blog-widget">
                                <h4 class="zq_blog-widget-title">Popular Tags</h4>
                                <div class="zq_blog-widget-tag">
                                    <a href="#">DigitalAI</a>
