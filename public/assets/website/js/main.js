...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /////////////////////////////////////////////////////
  // 01. Mouse Cursor Animation (Safe & Cleaned)
  ...
  function mousemoveHandler(e) {
    try {
      ...
      console.warn("Cursor GSAP Error:", error);
    }
  }
  ...
  /////////////////////////////////////////////////////
  // 02. ScrollSmoother Activation
  const device_width = window.innerWidth;

  const hasSmoothEl = document.getElementById("has_smooth");
  ...
  /////////////////////////////////////////////////////
  // 03. Heading Animations (SplitText + GSAP)

  if (typeof SplitText !== 'undefined') {
    const headingTimeline = gsap.timeline();

    const subtitleEl = document.querySelector(".tp_subtitle_anim");
    if (subtitleEl) {
      const subTitleSplit = new SplitText(subtitleEl, { type: "chars" });
      headingTimeline.from(subTitleSplit.chars, {
        x: 20,
        ease: "back.out",
        opacity: 0,
        duration: 1,
    ...
    const titleEl = document.querySelector(".tp_title_anim");
    if (titleEl) {
      const titleSplit = new SplitText(titleEl, { type: "chars, words" });
      headingTimeline.from(titleSplit.words, {
        x: 100,
        y: 0,
        z: -200,
        autoAlpha: 0,
    ...
    const descEl = document.querySelector(".tp_desc_anim");
    if (descEl) {
      const descSplit = new SplitText(descEl, { type: "chars, words" });
      headingTimeline.from(descSplit.words, {
        x: 50,
        autoAlpha: 0,
        duration: 1,
        stagger: 0.05,
